...
parser.add_argument('--source_data_dir', type=str, default='C:/zRHM/dataset', help='Path to the directory containing the audio_paths and text files.')
parser.add_argument('--output_data_dir', type=str, default='op_data_dir', help='Output data directory path.')
